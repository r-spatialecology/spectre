...
test <- spectre:::mh_optimizer(alpha_list_test, total_gamma_test, target_matrix_test, 2000)
test2 <- spectre:::mh_optimizer_neutral(alpha_list_test, total_gamma_test, target_matrix_test, 2000)
