...
test <- spectre:::optimizer(alpha_list_test, total_gamma_test, target_matrix_test, 20000)
test2 <- spectre:::optimizer(alpha_list, estimated_gamma, target_matrix_test, 20000)

resultdata <- test$optimized_grid
