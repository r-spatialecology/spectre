...
partial_solution_fixed <- tibble("1" = c(0,0,0,0,0,0),
                           "2" = c(0,0,0,0,0,0),
                           "3" = c(0,0,0,0,0,0),
                           "4" = c(0,0,0,0,0,0),
...
run_optimization_min_conf(alpha_list = alpha_list_test, 
                                     ...
                                     max_iterations = 0, 
                                     verbose = FALSE),
"The size of the partial_solution vector does not match n_sites * gamma_div. partial_solution ignored.", fixed=TRUE)
...
run_optimization_min_conf(alpha_list = alpha_list_test, 
                                     ...
                                     max_iterations = 0, 
                                     verbose = FALSE),
"The size of the fixed_species vector does not match n_sites * gamma_div. fixed_species ignored.", fixed=TRUE)
