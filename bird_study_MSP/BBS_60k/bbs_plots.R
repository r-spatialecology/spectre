...
ggsave("BBS60kDisc.png", path = "../../vignettes", width = 8, height = 6, units = "in")
...
ggsave("BBS60kPcor.png", path = "../../vignettes", width = 8, height = 6, units = "in")
...
ggsave("BBS60kRealizedSpec.png", path = "../../vignettes", width = 8, height = 6, units = "in")
