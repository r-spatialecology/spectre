...
Present updated results here

When test data was sampled from the BCI and BBS data, the algorithm was able to solve small- to medium-sized sized landscapes with a discrepancy in commonness $D_{com}$ < 0.1 and a proportion of > 0.8 correctly solved siteXsite pairs ($P_{correct}$). We thus believe that spectre is a valuable tool to generate (artificial) species compositions that match the constrains of $\alpha$- and $\beta$-diversity predictions. 
