...
where $C_{correct}$ is the number of cases/sites where $T_{com} - S_{com} == 0$, and m is the number of site x site pairs for a given landscape. Please note that we could even relax the assumption to $\lvert T_{com} - S_{com} \rvert < 3$, like Mokany do. This is kind of arbitrarily, but possible.     
