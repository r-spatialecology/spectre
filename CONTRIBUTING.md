...
This outlines how to propose a change to **spectre**. There are several
...
Browse the [documentation](https://r-spatialecology.github.io/spectre/)
to see if you can find a solution. Still stuck? Open an [issue on
GitHub](https://github.com/r-spatialecology/spectre/issues) on GitHub.
...
Take a look at the
[documentation](https://r-spatialecology.github.io/spectre/) and [issue
on GitHub](https://github.com/r-spatialecology/spectre/issues) list to
see if it isn’t included or suggested yet. If not, please open a new
issue!
...
GitHub](https://github.com/r-spatialecology/spectre/issues) so we can
...
1.  Fork [the repo](https://github.com/r-spatialecology/spectre) and
