...
bm <- bench::mark(
  ...
  spectre:::calculate_solution_commonness_site_rcpp(new_solution, solution_commonness, random_col),
  calculate_solution_commonness_site_R(new_solution, solution_commonness, random_col),
  iterations = 100
)
*/
