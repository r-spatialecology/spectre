...
// optimizer_min_conf
List optimizer_min_conf(const IntegerVector alpha_list, const unsigned total_gamma, const IntegerMatrix target, const unsigned max_iterations, const IntegerMatrix partial_solution, const IntegerMatrix fixed_species, const unsigned autostop, const unsigned long seed, const bool verbose, const bool interruptible);
RcppExport SEXP _spectre_optimizer_min_conf(SEXP alpha_listSEXP, SEXP total_gammaSEXP, SEXP targetSEXP, SEXP max_iterationsSEXP, SEXP partial_solutionSEXP, SEXP fixed_speciesSEXP, SEXP autostopSEXP, SEXP seedSEXP, SEXP verboseSEXP, SEXP interruptibleSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const unsigned >::type autostop(autostopSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(optimizer_min_conf(alpha_list, total_gamma, target, max_iterations, partial_solution, fixed_species, autostop, seed, verbose, interruptible));
