...
unsigned calc_error_random_solution(const unsigned n, const IntegerVector alpha_list, const unsigned total_gamma, const IntegerMatrix target, const unsigned long seed);
